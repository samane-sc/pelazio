...
if ($just_us) {
    ...
    if ($query->have_posts()) :?>
        <section class="second-slider slider-container just-our-product">
            <div class="row">
                <div class="col-lg-2 col-md-4 col-sm-4 col-4 first-slider__right">
                    <div class="second-slider__title">
                        <img src="<?php echo isset($options['product']['img6']) ? $options['product']['img6'] : ''; ?>" class="lazy" width="116px" height="116px"
                        alt="<?php echo isset($options['product']['link6_img']) && !empty($options['product']['link6_img']) ? $options['product']['link6_img'] : ''; ?>">
                        <h5><?php echo isset($options['product']['link6_img']) ? $options['product']['link6_img'] : ''; ?></h5>
                    </div>
