<?php
global $options;
$most_popular = $options['product']['ws_select2_speed_sending_products'];
if ($most_popular){
    $args = array(
    ...
    if ($query->have_posts()) :?>
        <section class="second-slider slider-container speed_sending_product">
            <div class="row">
                <div class="col-lg-2 col-md-4 col-sm-4 col-4 first-slider__right">
                    <div class="second-slider__title">
                        <img src="<?php echo isset($options['product']['img3'])? $options['product']['img3'] :''; ?>" width="116px" height="116px" class="lazy"
                        alt="<?php echo isset($options['product']['link3_img']) && !empty($options['product']['link3_img']) ? $options['product']['link3_img'] : ''; ?>">
                        <h5><?php echo isset($options['product']['link3_img'])? $options['product']['link3_img'] :''; ?></h5>
                    </div>
