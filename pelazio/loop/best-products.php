<?php
global $options;
$most_popular = $options['product']['ws_select2_best_products'];
if ($most_popular) {
    $args = array(
            ...
            <div class="row">
                <div class="col-lg-2 col-md-4 col-sm-4 col-4 first-slider__right">
                    <div class="second-slider__title">
                        <img src="<?php echo isset($options['product']['img2']) ? $options['product']['img2'] : ''; ?>" class="lazy" width="116px" height="116px"
                        alt="<?php echo isset($options['product']['link2_img']) && !empty($options['product']['link2_img']) ? $options['product']['link2_img'] : ''; ?>">
                        <h5><?php echo isset($options['product']['link2_img']) ? $options['product']['link2_img'] : ''; ?></h5>
                    </div>
